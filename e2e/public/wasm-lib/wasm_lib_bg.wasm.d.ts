...
export const apply_delta: (a: number, b: number, c: number, d: number) => [number, number, number, number];
export const borsh_decode_objects: (a: number, b: number) => [number, number, number, number];
export const borsh_decode_push_result: (a: number, b: number) => [number, number, number, number];
